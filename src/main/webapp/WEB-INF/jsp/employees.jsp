                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:forEach var="d" items="${departments}">
                                            <c:if test="${d.id == u.departementId}">${d.departement_name}</c:if>
                                        </c:forEach>
                                    </td>
                                    ...
                                    projects: '${u.projects}'
                                        ...
                                        <button class="btn-icon btn-delete"
                                            onclick="openDeleteModal('${u.id}')">🗑</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                            ...
                            <div class="form-group full-width">
                                ...
                                <select class="form-control" name="departement" id="departement" required>
                                    ...
                                    <c:forEach var="dept" items="${departments}">
                                        <c:if
                                            test="${dept.id != 0 || sessionScope.currentUser.role == 'ADMINISTRATEUR'}">
